...
<template>
  <div id="student">
    <el-row class="padding-50">
      <el-col :span="24">
        <ul class="list">
          <li class="logo"><i class="iconfont icon-kaoshi"></i><span>学生练习考试测试系统</span></li>
          <li><a href="javascript:;" @click="exam()">试卷</a></li>
          <li><a href="javascript:;" @click="practice()">练习</a></li>
          <li><router-link to="/scoreTable">分数</router-link></li>
