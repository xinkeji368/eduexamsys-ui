...
export default {
  data() {
    return {
      ...
      imgSrc: {
        fail1: require("@/assets/img/cry1.png"),
        fail2: require('@/assets/img/cry2.png'),
        pass1: require('@/assets/img/66.png'),
        pass2: require('@/assets/img/666.png')
      },
