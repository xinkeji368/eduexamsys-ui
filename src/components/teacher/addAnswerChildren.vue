...
<template>
  <div class="add">
    ...
    <el-tab-pane name="first">
      ...
      <section class="append">
        <ul>
          ...
          <li >
            <span>分值：</span>
            <span style="display: inline-block;border: 1px solid #ccc;padding: 5px;width: 110px;height: 25px">
              2分
            </span>
          </li>
    ...
    <el-tab-pane name="second">
      ...
      <el-tab-pane name="second">
        <span slot="label"><el-button  @click="expurgate()">重置试卷</el-button></span>
      </el-tab-pane>
  </el-tabs>
  </div>
</template>
    ...
    expurgate() {
      this.$axios({
        ...
        alert(JSON.stringify(res));
          window.location.href = "http://localhost:8088/#/addAnswer"
      })
    },
    getParams() {
